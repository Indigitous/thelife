...
public class IntegrationTest extends AndroidTestCase implements ServerListener, DSRefreshedListener {
	...
	// data stores
	private static DeedsDS m_ownerDeedsDS = null;
	private static CategoriesDS m_ownerCategoriesDS = null;
	...
	synchronized public void test1() {
		...
		m_ownerCategoriesDS = new CategoriesDS(getContext(), m_ownerToken);
		m_ownerDeedsDS = new DeedsDS(getContext(), m_ownerToken);
